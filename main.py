...
def theory():
    ...
    return render_template('theory.html', theory1=theory1, theory2=theory2, theory3=theory3, theory4=theory4, theory5=theory5)
    ...
    if request.method == 'POST':
        ...
        for component in test1:
            ...
            if user_answer == correct_answer:
                score+=1 # Или как вы хотите сохранять результаты
    ...
    if request.method == 'POST':
        ...
        if action == 'save_user':
            ...
            if password == "":
                ...
                updateUser = conn.execute('UPDATE users SET password = ?, admin = ? WHERE username = ?', (newpassword, admin, login,)).fetchone()
            conn.commit()
            conn.close()
...
if __name__ == "__main__":
    app.run(host='192.168.1.34', port='8080')
